...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final CursorFactory cursorFactory = null; //null means default cursorFactory
    ...
    public DatabaseHelper(Context context) { super(context, DATABASE_NAME, cursorFactory, DATABASE_VERSION); }
